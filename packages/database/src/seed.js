...
const tasks = [
    {
        ...
        status: index_1.TaskStatus.PENDING,
    },
    {
        ...
        durationMins: 60,
        priority: index_1.Priority.MEDIUM,
        status: index_1.TaskStatus.IN_PROGRESS,
    },
    {
        ...
        durationMins: 45,
        priority: index_1.Priority.LOW,
        status: index_1.TaskStatus.COMPLETED,
    },
];
async function main() {
    await index_1.db.$transaction(async (prisma) => {
